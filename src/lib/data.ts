...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'OS-inspired portfolio: boot sequences, process tables, and a neural net skills graph.',
    url: '#',
    startDate: '2025-01',
  },
  {
    ...
    status: 'active',
    lang: ['Python', 'C++', 'CUDA'],
    description: 'Benchmarking suite measuring ML inference throughput across heterogeneous hardware.',
    startDate: '2024-09',
  },
  {
    pid: 3141,
    ...
    status: 'completed',
    lang: ['C', 'Rust'],
    description: 'ONNX runtime for ARM Cortex-M: quantized models on 256KB RAM.',
    url: '#',
    startDate: '2024-03',
  },
  {
    ...
    status: 'completed',
    lang: ['Go'],
    description: 'Distributed key-value store with Raft consensus; linearizable reads, snapshot install.',
    url: '#',
    startDate: '2024-01',
  },
  {
    ...
    status: 'archived',
    lang: ['C'],
    description: 'Preemptive scheduler for xv6: multilevel feedback queue with aging.',
    startDate: '2023-10',
  },
  {
    pid: 34,
    ...
    status: 'archived',
    lang: ['OCaml'],
    description: 'Interpreter for a typed lambda calculus with Hindley-Milner type inference.',
    startDate: '2023-06',
  },
];
